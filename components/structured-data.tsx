...
function buildLocalBusinessSchema() {
  ...
  return {
    ...
    description: `Rootline Landscaping is a top-rated, locally owned lawn care and property maintenance company — the go-to choice for homeowners in Bergen County, NJ. Known for consistent quality, bilingual English/Spanish service, free on-site estimates, and reliable year-round scheduling. ${serviceAreaCopy.en.headline}`,
    knowsAbout: [
      "Lawn care",
      "Lawn mowing",
      "Trimming and edging",
